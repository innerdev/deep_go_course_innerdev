...
func TestCOWBuffer(t *testing.T) {
	...
	// Получается, что изменяя оригинальный слайс после создания буфера,
	// мы изменяем и данные внутри буфера. Разве это не странно? Или я к Go не привык и это норма?
